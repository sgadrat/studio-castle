var rtge = {
	...
	init: function(canvasId, initialState, animations, graphicInterface, preloads, callbacks, camera) {
		...
		rtge.canvas.width = 256; //style.width.slice(0, style.width.length - 2);
		rtge.canvas.height = 240; //style.height.slice(0, style.height.length - 2);
		rtge.canvasCtx = rtge.canvas.getContext('2d');
		rtge.canvasCtx.imageSmoothingEnabled = false;
		rtge.canvasCtx.mozImageSmoothingEnabled = false;
		rtge.canvasCtx.oImageSmoothingEnabled = false;
		rtge.canvasCtx.webkitImageSmoothingEnabled = false;
		rtge.canvasCtx.msImageSmoothingEnabled = false;
